    ...
    <footer className="border-border bg-background">
      <div className="mx-auto max-w-7xl px-6 pb-20">
        <div className="text-center">
          <h2 className="text-foreground from-foreground to-foreground/60 mb-4 bg-gradient-to-r bg-clip-text font-sans text-4xl font-bold tracking-tight text-balance text-transparent md:text-4xl">
